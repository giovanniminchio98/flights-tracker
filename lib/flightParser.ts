...
import type { FlightCandidate, RawCalendarEvent } from "@/types/flight";
...
/** Parses a raw calendar event (from either Google Calendar or iCloud CalDAV)
 * into a structured flight candidate, using shared text heuristics. Returns
 * null if the event doesn't look like a flight. */
